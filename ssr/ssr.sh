...
# Link Hosting Kalian
f="raw.githubusercontent.com/bangfrax/scriptvps/main/ssr"
...
config_user_api_file="${ssr_folder}/useficonfig.py"
...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://${f}/ssrmu"
...
Install_SSR
wget -O /usr/bin/ssr https://${f}/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/addssr https://${f}/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://${f}/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/renewssr https://${f}/renewssr.sh && chmod +x /usr/bin/renewssr
