...
# ==================================================
# Link Hosting Kalian
f="raw.githubusercontent.com/bangfrax/scriptvps/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://${f}/addwg.sh"
wget -O delwg "https://${f}/delwg.sh"
wget -O renewwg "https://${f}/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
