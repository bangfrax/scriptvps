...
# Link Hosting Kalian
f="raw.githubusercontent.com/bangfrax/scriptvps/main/sstp"
...
touch /var/lib/fraxvpn/data-user-sstp
...
wget -O /etc/accel-ppp.conf "https://${f}/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://${f}/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://${f}/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://${f}/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://${f}/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
