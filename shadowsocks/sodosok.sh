...
# Link Hosting Kalian
f="raw.githubusercontent.com/bangfrax/scriptvps/main/shadowsocks"
...
cd /usr/bin
wget -O addss "https://${f}/addss.sh"
wget -O delss "https://${f}/delss.sh"
wget -O cekss "https://${f}/cekss.sh"
wget -O renewss "https://${f}/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x renewss
