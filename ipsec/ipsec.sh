...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/bangfrax/perizinan/main/ipvps.txt | grep $MYIP )
if [ $MYIP = $MYIP ]; then
echo -e "${NC}${GREEN}Permission Accepted...${NC}"
else
echo -e "${NC}${RED}Permission Denied!${NC}";
echo -e "${NC}${LIGHT}Please Contact Admin!!"
echo -e "${NC}${LIGHT}Facebook : https://m.facebook.com/rebi.saikhu"
echo -e "${NC}${LIGHT}WhatsApp : 082118248696"
echo -e "${NC}${LIGHT}Telegram : https://t.me/fraxstore"
exit 0
fi
# ==================================================
# Link Hosting Kalian
f="raw.githubusercontent.com/bangfrax/scriptvps/main/ipsec"
...
if [[ ${OS} == "centos" ]]; then
epel_url="https://dl.fedofroject.org/pub/epel/epel-release-latest-$(rpm -E '%{rhel}').noarch.rpm"
...
wget -O /usr/bin/addl2tp https://${f}/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://${f}/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://${f}/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://${f}/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://${f}/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://${f}/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
touch /var/lib/fraxvpn/data-user-l2tp
touch /var/lib/fraxvpn/data-user-pptp
rm -f /root/ipsec.sh
